...
class FindPwdTimer extends StatelessWidget{
  final SupportUI supportUI;
  final JakomoColor jakomoColor;
  FindPwdTimer({Key? key, required this.supportUI, required this.jakomoColor}):super(key: key);
  ...
  final FindPwdTimerController jakomoAuthTimerController = Get.find();
  final FindPwdController signinController = Get.find();
  @override
