...
import 'package:jakomo_recliner/Page/MemberShip/SignInPage/signin_button.dart';
...
class SignInFooter extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _SignInFooter();
}

class _SignInFooter extends State<SignInFooter> {
    ...
    return Obx((){
      return Column(
        ...
        children: [
          ...
          SigninButton(supportUI: supportUI, jakomoColor: jakomoColor, commonUI: commonUI)
        ],
      );
    });
  }
