...
class InquiryFormSelect extends StatefulWidget {
  ...
  InquiryFormSelect(
      ...
      : super(key: key);
  final List<String> _selectList = ['회원정보 문의', '상품 문의', '시스템 문의', '기타 문의'];
  ...
  @override
  State<StatefulWidget> createState() => _InquiryFormSelect();
}

class _InquiryFormSelect extends State<InquiryFormSelect> {
  ...
  String _selected = '상담 내용을 선택해주세요.';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: _dropDownOpen
          ? supportUI.resWidth(56) * 5 + supportUI.resWidth(4)
...
class InquiryFormSelectItem extends StatelessWidget {
  final SupportUI supportUI;
  final JakomoColor jakomoColor;
  final String item;

  InquiryFormSelectItem(
      {Key? key,
