...
import 'inquiry_form_controller.dart';

class InquiryFormImg extends StatelessWidget {
  final SupportUI supportUI;
  final JakomoColor jakomoColor;

  InquiryFormImg({Key? key, required this.supportUI, required this.jakomoColor})
      : super(key: key);
  ...
  final InquiryFormController inquiryFormController = Get.find();
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Obx(() {
                    return inquiryFormController.imgList.isNotEmpty
                        ? Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: List.generate(
                                inquiryFormController.imgList.length,
                                (index) => Padding(
                                      padding: EdgeInsets.only(
                                          right: supportUI.resWidth(16)),
                                      child: _imgItem(
                                          inquiryFormController.imgList[index]
                                              as XFile,
                                          index),
                                    )),
                          )
  ...
  Future<XFile?> _selectImage() async {
    await _imagePicker.pickImage(source: ImageSource.gallery).then((value) {
      if (value != null) {
        inquiryFormController.imgList.add(value);
      }
    });
  }
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          inquiryFormController.imgList.removeAt(index);
                        },
                        child: Container(
